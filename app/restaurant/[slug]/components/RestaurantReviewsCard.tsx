...
export interface RestaurantReviewsCardProps {
  review: Review;
}

export default function RestaurantReviewsCard({ review }: RestaurantReviewsCardProps) {
      ...
      <div className="flex">
        <div className="w-1/6 flex flex-col items-center">
          <div className="rounded-full bg-blue-400 w-16 h-16 flex items-center justify-center">
            <h2 className="text-white text-2xl uppercase">{getInitialsName(fullName)}</h2>
          </div>
